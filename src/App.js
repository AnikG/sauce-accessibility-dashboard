...
import wdioLog from './wdio_test_log_no_axe.json';
    ...
    return (
      <div>
        ...
        <div role="main" style={{border: '2px dashed orange', padding: '2em'}}>
          ...
          <hr />
          <p>Resources:</p>
          <p>TODO: Make the target page <a href="https://deque.com/saucelabs/getting-started">Getting Started with Accessibility Testing on Sauce</a></p>
          <p>TODO: Make a more relevant video <a href="https://www.youtube.com/watch?v=-n5Ul7WPc3Y">Video tutorial on Accessibility Testing</a></p>
        </div>
      </div>
      );
  }
